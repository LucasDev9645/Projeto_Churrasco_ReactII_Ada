            ...
            <Dialog.Portal>
                <Dialog.Overlay className="inset-0 fixed bg-black/50 flex justify-center items-center">
                    <Dialog.Content className="flex flex-wrap md:flex-nowrap relative bg-amber-50 text-amber-950 outline-none rounded-md ring-2 m-5 ring-amber-400">
                        <Dialog.Close className="bg-amber-400 hover:bg-amber-300 rounded-bl-md absolute top-0 right-0 p-2"><X size={22}  /></Dialog.Close>
                        <div className="p-5">
                            <h2 className="font-Staatliches text-xl sm:text-2xl flex items-center gap-2 mb-2"><Laptop /> Frontline Coders</h2>
                        ...
                        <div className="h-[200px] w-full md:w-[347px] md:min-h-[480px]">
                            <img src={PosterImage} className="w-full md:w-[347px] h-full object-cover object-bottom bg-amber-500" />
                        </div>
                    </Dialog.Content>
                </Dialog.Overlay>
            </Dialog.Portal>
