      ...
      <div className="max-w-[1480px] mx-auto flex flex-wrap gap-4 items-center justify-around sm:justify-between p-5">
        ...
        <nav>
          <ul className="flex gap-4 font-semibold">
            <li><Link to="/edit-barbecue" className="flex items-center gap-2 px-4 py-3 rounded-md bg-amber-300 border-2 border-amber-400 hover:bg-amber-400 text-neutral-800 hover:text-amber-950"><PlusCircle />Criar Churrasco</Link></li>
          </ul>
        </nav>
      </div>
    </header>
