...
export function NoCards() {
    return (
        <Link to="/edit-barbecue" className="flex items-center justify-center h-[200px] w-full bg-amber-100 hover:bg-amber-200 hover:cursor-pointer col-span-4 rounded-md ring-1 ring-amber-400">
